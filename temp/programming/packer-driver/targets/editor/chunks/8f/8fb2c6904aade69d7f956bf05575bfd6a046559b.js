    ...
    execute: function () {
      ...
      _export("CollisionSystem", CollisionSystem = class CollisionSystem {
        checkPlayerVsItems(player, items) {
          const pw = (_crd && CollisionConstants === void 0 ? (_reportPossibleCrUseOfCollisionConstants({
            error: Error()
          }), CollisionConstants) : CollisionConstants).PLAYER_HALF_W;
          const ph = (_crd && CollisionConstants === void 0 ? (_reportPossibleCrUseOfCollisionConstants({
            error: Error()
          }), CollisionConstants) : CollisionConstants).PLAYER_HALF_H;
          const iw = (_crd && CollisionConstants === void 0 ? (_reportPossibleCrUseOfCollisionConstants({
            error: Error()
          }), CollisionConstants) : CollisionConstants).ITEM_HALF_W;
          const ih = (_crd && CollisionConstants === void 0 ? (_reportPossibleCrUseOfCollisionConstants({
            error: Error()
        ...
        checkPlayerVsNPCs(player, npcs) {
          ...
          const nw = (_crd && CollisionConstants === void 0 ? (_reportPossibleCrUseOfCollisionConstants({
            error: Error()
          }), CollisionConstants) : CollisionConstants).NPC_HALF_W;
          const nh = (_crd && CollisionConstants === void 0 ? (_reportPossibleCrUseOfCollisionConstants({
            error: Error()

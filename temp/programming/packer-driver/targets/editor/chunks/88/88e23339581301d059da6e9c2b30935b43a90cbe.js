  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property([Node]), _dec(_class = (_class2 = class GameController extends Component {
        ...
        onDestroy() {
          const bus = (_crd && EventBus === void 0 ? (_reportPossibleCrUseOfEventBus({
            error: Error()
        ...
        _initLightPoints() {
          ...
          for (let i = 0; i < this.lightPointNodes.length; i++) {
            const model = new (_crd && LightPointModel === void 0 ? (_reportPossibleCrUseOfLightPointModel({
              error: Error()
            ...
            const view = this.lightPointNodes[i].getComponent(_crd && LightPointView === void 0 ? (_reportPossibleCrUseOfLightPointView({
              error: Error()
        ...
        _tryActivateLightPoints() {
          const shards = this._inventory.getCount((_crd && ItemType === void 0 ? (_reportPossibleCrUseOfItemType({
            error: Error()
          }), ItemType) : ItemType).SHARD);

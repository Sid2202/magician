  ...
  return {
    ...
    execute: function () {
      ...
      _export("InputSystem", InputSystem = class InputSystem {
        ...
        readInto(target) {
          var jx = Math.abs(this._joystickAxis.x) > (_crd && PlayerConstants === void 0 ? (_reportPossibleCrUseOfPlayerConstants({
            error: Error()
          }), PlayerConstants) : PlayerConstants).INPUT_DEADZONE ? this._joystickAxis.x : 0;
          var jy = Math.abs(this._joystickAxis.y) > (_crd && PlayerConstants === void 0 ? (_reportPossibleCrUseOfPlayerConstants({
            error: Error()
